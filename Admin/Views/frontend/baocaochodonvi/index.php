...
<body>
    ...
    <nav class="navbar navbar-light justify-content-between" style="background-color: #e3f2fd">
        <a  href="./index.php?controller=thongketheodonvi"><button class="btn btn-primary">Thống kê mũi tiêm</button></a>
        ...
        <form method="post" action="./index.php?controller=thongketheodonvi" class="form-inline">
    ...
    <div class="container-fluid">
        <form method="post" action="./index.php?controller=thongketheodonvi" class="form-inline mt-3">
            ...
            <div class="container">
                ...
                <table id="tableExcel" class="table table-bordered mt-2">
                    ...
                    <tbody class="row-table">
                        <?php 
                            $sum = 0;
                            $lastIndex = $maxMuitiemthu + 1 ;
                            for($i = 0; $i<$maxMuitiemthu; $i++){
                                $stt = $i +1;
