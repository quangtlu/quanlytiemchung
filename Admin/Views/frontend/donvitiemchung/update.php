...
<head>
    ...
    <title>Sửa thông tin Đơn vị tiêm</title>
...
<body>
    ...
    <div class="container mt-5 animate__animated animate__fadeIn">
        ...
        ?>
        <form method="POST"
            action="./index.php?controller=donvitiemchung&action=update&id=<?php echo $donvis["ID_DonVi"]?>"
            ...
            <div class="form-row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select id="ward" value="" class="form-control" name="ward"></select>
                </div>
            </div>
            <div class="form-row">
                <div class="col-md-4 mb-3">
                    <label for="validationCustom01">Tên đơn vị</label>
                    <input type="text" value="<?php echo $donvis["TenDonVi"]; ?>" class="form-control"
                        id="validationCustom01" name="tendonvi" placeholder="Tên đơn vị tiêm chủng" value="" required>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" value="<?php echo $donvis["SoBanTiem"]; ?>" class="form-control"
                        id="validationCustom02" name="sobantiem" placeholder="Số bàn tiêm" value="" required>
                    <div class="invalid-feedback">
                        Nhập số bàn tiêm
                    </div>
                </div>
