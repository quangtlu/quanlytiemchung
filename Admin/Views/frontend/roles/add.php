                ...
                <div class="col-md-6 mb-6">
                    ...
                    <div class="custom-control custom-checkbox mt-3">
                        <input type="checkbox" name="chucnang[]" class="custom-control-input"
                            value="Quản lý đơn vị tiêm chủng" id="chucnang2">
                        <label class="custom-control-label" for="chucnang2">Quản lý đơn vị tiêm chủng</label>
                    </div>
                    <div class="custom-control custom-checkbox mt-3">
                        <input type="checkbox" name="chucnang[]" class="custom-control-input" value="Quản lý vaccine"
                            id="chucnang3">
                        <label class="custom-control-label" for="chucnang3">Quản lý vaccine</label>
                    </div>
                    <div class="custom-control custom-checkbox mt-3">
                        <input type="checkbox" name="chucnang[]" class="custom-control-input"
                            value="Quản lý đơn đăng ký tiêm" id="chucnang4">
                        <label class="custom-control-label" for="chucnang4">Quản lý đơn đăng ký tiêm chủng</label>
                    </div>
                    <div class="custom-control custom-checkbox mt-3">
                        <input type="checkbox" name="chucnang[]" class="custom-control-input"
