...
<body>
    ...
    <div class="container animate__animated animate__fadeIn mb-5">
        ...
        <form method="POST"
            action="./index.php?controller=dondangkytiem&action=update&phone=<?php echo $_SESSION['phone'] ?>"
            novalidate>
            <div id="muitiem" class="form-row">
                <div class="col-md-4 mb-6">
                    <label for="muitiemthu" class="form-label">Đăng ký mũi tiêm thứ<span
                            class="require">(*)</span></label>
                    <select name="muitiemthu" value="" class="form-control" required id="muitiemthu">
                        <?php 
                            if($flag){
                                echo '<option id="muithu2" value="2">Mũi thứ hai</option>';
                            }
                            else{
                                echo '<option value="1">Mũi thứ nhất</option>';
                            }
                        ?>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select id="uutien" required class="form-control form-select" name="uutien">
                        <option title="<?php echo $dondangkyInfo["NhomUuTien"] ?>">
                            <?php echo $dondangkyInfo["NhomUuTien"] ?></option>
                        <optgroup>
                ...
                <div class="col-md-4 mb-6">
                    ...
                    <input id="ngaymongmuon" value="<?php echo $dondangkyInfo["NgayMongMuon"] ?>" name="ngaymongmuon"
                        type="date" placeholder="" class="form-control">
                </div>
            </div>
            <!-- <div id="lichsutiem" style="display:none">
                <h3 style="color: var(--primary-color); margin-top:10px">Lịch sử tiêm mũi 1:</h3>
                <div class="form-row">
                    <div class="col-md-4 mb-3">
                        <label class="form-label" for="tenvacxin">Tên vắc xin <span class="require">(*)</span></label>
                        <input id="tenvacxin" class="form-control" type="text" required name="tenvacxin" placeholder="Tên vắc xin">
                        <div class="invalid-feedback">
                            Vui lòng chọn tên vắc-xin
                        </div>
                    </div>
                    <div class=" col-md-4">
                        <label for="ngaytiem" class="form-label">Ngày tiêm <span class="require">(*)</span></label>
                        <input required id="ngaytiem" name="ngaytiem" type="date" placeholder="Ngày tiêm" class="form-control">
                        <div class="invalid-feedback">
                            Vui lòng nhập Ngày tiêm
                        </div>
                    </div>
                    <div class=" col-md-4">
                        <label for="donvitiem" class="form-label">Đơn vị tiêm <span class="require">(*)</span></label>
                        <input required id="donvitiem" name="donvitiem" type="text" placeholder="Đơn vị tiêm" class="form-control">
                        <div class="invalid-feedback">
                            Vui lòng Đơn vị tiêm
                        </div>
                    </div>
                    <div class="col-md-12">
                        <label class="form-label" for="trieuchung">Phản ứng sau khi tiêm</label>
                        <textarea class="form-control" style="resize:none" name="trieuchung" id="trieuchung" cols="30" rows="10"></textarea>
                    </div>
                </div>
        </div> -->
            <div class="form-row">
            ...
            <div class="button-wrap">
                <a href="./index.php?controller=dondangkytiem&action=tracuu&phone=<?php echo $_SESSION['phone']?>"><button
                        type="button" class="button cancel-btn">Huỷ bỏ</button></a>
                <button type="submit" class="form-submit button register-btn">Cập nhật</button>
            </div>
        </form>
    </div>

    <!-- main -->
    <?php $this->view('frontend.public.js.provinces');?>
    <?php $this->view('frontend.public.footer') ?>
    <!-- <script>
    const muitiemthu = document.querySelector("#muitiemthu");
    const lichsutiem = document.querySelector("#lichsutiem");

    function lichsumuitiem(){
        if(muitiemthu.value == 2){
            lichsutiem.style.display = "block";
        }
        else{
            lichsutiem.style.display = "none";
        }
    }
</script> -->
</body>
